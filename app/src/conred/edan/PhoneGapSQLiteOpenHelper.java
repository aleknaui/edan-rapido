...
/**
 * PhoneGapSQLiteOpenHelper is a class that is based on SQLiteOpenHelper except
 ...
 */
public abstract class PhoneGapSQLiteOpenHelper {
    private static final String TAG = PhoneGapSQLiteOpenHelper.class
            .getSimpleName();
     ...
     */
    public PhoneGapSQLiteOpenHelper(String dir, String name,
